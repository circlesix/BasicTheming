# Basic Theming in Magento 2

This is an example theme to follow along with my tutorial series covering the themes Magento 2. The `master` branch has the minimun required files to register your theme. Each branch will match the blog post with the final code of the tutorial. There is no need to copy this repo to follow along, each post will cover all the needed code. This repo exists as a reference for the work we are doing along the way. 

The blog series began [with this post about The Basics of Magento 2 Theming](http://circlesixdigital.com/introduction-to-javascript-in-magento-2/). There is no code associated with that post. 

## Getting Started

Clone this repo into your Magento install at `{magento_root}/app/design/frontend`
with `git clone https://github.com/circlesix/BasicTheming.git` from the command line. 
